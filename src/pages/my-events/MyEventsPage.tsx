        ...
        <main className="me__main">
          ...
          {sidebarTab === 'saved' && (
            <>
              ...
              <p className="me__subtitle">
                {isVenue
                  ? 'Здесь находятся мероприятия, которые были сохранены. Вы всегда можете к ним вернуться, чтобы предложить сотрудничество.'
                  : 'Здесь находятся пространства, которые были сохранены. Вы всегда можете к ним вернуться, чтобы предложить сотрудничество.'}
              </p>
              {savedLoading ? (
                <p className="me__empty">Загрузка...</p>
              ) : isVenue ? (
