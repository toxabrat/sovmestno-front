        ...
        <header className="ce__header">
          ...
          <div>
            <h1 className="ce__title">
              {copyId ? 'Разместить заново' : editId ? 'Редактировать мероприятие' : 'Создание мероприятия'}
            </h1>
            <p className="ce__subtitle">
              Вы можете добавить подробные снимки пространства, рассказать о своих пожеланияхи поделиться ссылками на соц сети. Сделать это можно позже из своего профиля
            </p>
          </div>
        </header>
